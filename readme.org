...
**** Extra Packages
I like to have language highlighting for nix, and I also want my colorscheme setup.
#+name: nvimExtraPkgs
#+begin_src nix
...
**** Configuration
I want to use lua to learn to configure neovim.
...
***** Functionality
I like to use 2 spaces for a tab, and I want to set up
** Git
